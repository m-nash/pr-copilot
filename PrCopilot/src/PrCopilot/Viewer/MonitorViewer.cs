...
public static class MonitorViewer
{
    ...
    public static void Run(int prNumber, string logFile, string triggerFile, string? debugFile = null)
    {
        ...
        {
            Text = $"🔗 {headerText}", X = 0, Y = 0, Width = Dim.Fill(),
            ColorScheme = linkScheme, NoPadding = true, NoDecorations = true,
            CanFocus = false
        };
        ...
        var ciFrame = new FrameView
        {
            ...
            X = 0, Y = 2, Width = Dim.Fill(), Height = 3,
        ...
        var approvalsFrame = new FrameView
        {
            ...
            X = 0, Y = Pos.Bottom(ciFrame), Width = Dim.Fill(), Height = 3,
            ColorScheme = dimScheme,
            CanFocus = false
        };
        ...
        var commentsFrame = new FrameView
        {
            ...
            X = 0, Y = Pos.Bottom(approvalsFrame), Width = Dim.Fill(), Height = 3,
            ColorScheme = dimScheme,
            CanFocus = false
        };
        ...
        var waitingFrame = new FrameView
        {
            ...
            X = 0, Y = Pos.Bottom(commentsFrame), Width = Dim.Fill(), Height = 3,
            ColorScheme = dimScheme,
            CanFocus = false
        };
        ...
        {
            Text = "",
            X = 0, Y = Pos.Bottom(waitingFrame), Width = Dim.Fill(),
            ColorScheme = dimScheme
        };
        ...
        {
            X = 0, Y = Pos.Bottom(updatedLabel), Width = Dim.Fill(),
        ...
        {
            X = 0, Y = Pos.Bottom(separator), Width = Dim.Fill(), Height = 1,
            Fraction = 0f, ProgressBarStyle = ProgressBarStyle.Continuous,
        ...
        {
            Text = "Waiting...",
            X = 0, Y = Pos.Bottom(progressBar), Width = Dim.Fill(15)
        };

        var checkButton = new Button
        {
            Text = "Check Now",
            X = Pos.AnchorEnd(14), Y = Pos.Bottom(progressBar),
            Enabled = false, ColorScheme = darkScheme
        };

        var extendButton = new Button
        {
            Text = "Add 2h",
            X = Pos.AnchorEnd(24), Y = Pos.Bottom(progressBar),
        ...
        var debugToggleButton = new Button
        {
            ...
            X = 0, Y = Pos.Bottom(statusLabel) + 1,
        ...
        {
            Title = "Debug Log",
            X = 0, Y = Pos.Bottom(debugToggleButton), Width = Dim.Fill(), Height = Dim.Fill(),
            ColorScheme = dimScheme,
            Visible = false
        };
